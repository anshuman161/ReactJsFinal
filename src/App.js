...
import getElasticSearch from './pages/getelasticsearch';
import getNotesLabel from './pages/getNotesLabel'
...
function App() {
  return (
    <Router>
      ...
      <Route path = "/elasticsearch" component = {getElasticSearch}/>
      <Route path = "/getnoteslabel/:labelId" component = {getNotesLabel}/>
    </Router>
  );
}
