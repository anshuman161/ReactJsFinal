...
export default class DownBar extends Component {
    ...
    handleColorFresh=(colorstatus)=>{
           this.setState({
            colorstatus:colorstatus
           })
           this.props.handlecolorstatus(this.state.colorstatus)
    }
    render() {
        return (
            <div className='iconDisplay'>
                <div>
                    <IconButton style={{padding:'4px',marginRight:'15px'}}>
                     <Reminder noteId={this.props.noteId} status={this.handleFresh}/>
                    </IconButton>
                 </div>  
                 <div>
                    <IconButton style={{padding:'4px',marginRight:'15px'}}>
              ...
              <ColorChange noteId={this.props.noteId} colorstatus={this.handleColorFresh}/>
                    </IconButton>
                 </div>  
                 <div>
                    {/* <IconButton style={{padding:'4px',marginRight:'15px'}}>
