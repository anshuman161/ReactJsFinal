        ...
        let displayNotes = this.state.allNotes.map((object, index)=>{
            ...
            <div>
              <CardContent >
                ...
                <br/>
                <div>
                <DownBar noteId={object.noteId}  sendstatus={this.handlefreshremind}  handlecolorstatus={this.handlechangecolor}/>
                </div>
              </CardContent>
            </div>
