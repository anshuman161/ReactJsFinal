      ...
      const cardView = this.props.viewprop ? "display-card" : "list-view"
        let displayNotes = this.state.allNotes.map((object, index)=>{
            ...
            <div>
                ...
                <div className='iconDisplay'>
                 ...
                 <div>
                    <IconButton style={{padding:'4px',marginRight:'15px'}}>
                     <Reminder noteId={this.props.noteId} sendstatus={this.handlefresh} />
                    </IconButton>
                 </div>  
              ...
              <ColorChange noteId={object.noteId}   handlecolorstatus={this.handleColorFresh} />
                    </IconButton>
                 </div>  
                 <div>
                    {/* <IconButton style={{padding:'4px',marginRight:'15px'}}>
